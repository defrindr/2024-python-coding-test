    ...
    <div class="row same-height">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-horizontal d-flex flex-column gap-3" action="{{ route('profile.update') }}" method="post">
              @csrf
              @method('PATCH')
      ...
      @if ($user->role == 'admin')
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="form-horizontal d-flex flex-column gap-3" action="{{ route('profile.updateSekolah') }}"
                method="post">
                @csrf
                @method('PATCH')
                <div class="d-flex gap-3">
